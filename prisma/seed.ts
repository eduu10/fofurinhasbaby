...
async function main() {
  ...
  const products = [
    ...
    { title: "Kit Banho Bebê Completo", slug: "kit-banho-bebe-completo", description: "Kit banho hipoalergênico.", shortDescription: "Kit banho 3 itens", price: 89.90, compareAtPrice: 119.90, costPrice: 32.00, stock: 80, isFeatured: true, salesCount: 312, categoryId: categories[3].id, images: ["https://images.unsplash.com/photo-1544006659-f0b21884ce1f?w=600"], variations: [] },
    { title: "Mamadeira Anticólica 260ml", slug: "mamadeira-anticolica-260ml", description: "Mamadeira anticólica.", shortDescription: "Mamadeira anticólica", price: 45.90, costPrice: 15.00, stock: 120, salesCount: 198, categoryId: categories[4].id, images: ["https://images.unsplash.com/photo-1584839404042-8bc91fbb605b?w=600"], variations: [{ name: "Cor", value: "Rosa", stock: 40 }, { name: "Cor", value: "Azul", stock: 40 }] },
